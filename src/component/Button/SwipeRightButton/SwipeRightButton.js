...
export default class SwipeRightButton extends Component {
  static defaultProps = {
    value: false,
    onChangeValue: () => null,
    activeText: '',
  ...
  _panResponder = PanResponder.create({
    ...
    onPanResponderMove: (evt, gestureState) => {
      this.setState(state => {
        const { transformValue } = state
        console.log(gestureState.moveX)
        transformValue.setValue(gestureState.dx)
      });
    },
        ...
        >
          ...
          <Animated.View
            style={[{
              ...
              transform: [
                {
                  translateX: this.state.transformValue,
                }
              ]
            }]}
          />
