...
type Props = {};
class OfferActivity extends Component<Props> {
  static defaultProps = {
        ...
        >
          <View style={styles.details}>
            <View style={styles.rowDetails}>
              <Text style={styles.rowTextDetails}>Pesanan 1</Text>
            </View>
            <View style={styles.rowDetails}>
              <Text style={styles.rowTextDetails}>Pesanan 2</Text>
            </View>
            <View style={styles.rowDetails}>
              <Text style={styles.rowTextDetails}>Pesanan 3</Text>
            </View>
            <View style={styles.rowDetails}>
              <Text style={styles.rowTextDetails}>Pesanan 4 </Text>
            </View>
          </View>
        </ScrollView>
      </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(OfferActivity)
